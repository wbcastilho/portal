...
@section('subtitulo')
    Permissões <small>(Formulário)</small> 
@endsection
...
@section('content')   
    ...
    <form id="meuForm" class="form" role="form" action="{{ route('permissoes.store') }}" enctype="multipart/form-data" method="post">
        {{csrf_field()}} 

        <div class="box-body">
            @include('site.permissoes._form')                   
        </div>                       
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Permissão cadastrada com sucesso!</p>
                </div>
