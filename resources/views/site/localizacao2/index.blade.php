...
@section('content')        
    ...
    <form action="localizacao2" method="GET">
        @can('localizacao-create') 
            <a href="{{ route('localizacao2.create') }}" type="button" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i> Adicionar</a>                
        @endcan
        {{csrf_field()}}
          ...
          @if (count($localizacoes) > 0)
            @foreach ($localizacoes as $localizacao)               
                <tr>                             
                    ...
                    <td style="vertical-align:middle;">{{ $localizacao->localizacao1->estado->uf }}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Confirma a exclusão da localização 2 selecionada?</p>
                </div>
