<div class="row">
    <div class="form-group col-md-5 col-sm-5 col-xs-12 {{ $errors->has('fabricante_id') ? 'has-error' : ''}}">
        ...
        <select {{ Request::segment(4) == 'edit' ? "disabled" : "" }} id="fabricante_id" name="fabricante_id" class="form-control">
...
<div class="row">
    <div class="form-group col-md-5 col-sm-5 col-xs-12 {{ $errors->has('tipo_id') ? 'has-error' : ''}}">
        ...
        <select {{ Request::segment(4) == 'edit' ? "disabled" : "" }} id="tipo_id" name="tipo_id" class="form-control">
...
<div class="row">
    <div class="form-group col-md-5 col-sm-5 col-xs-12 {{ $errors->has('modelo_id') ? 'has-error' : ''}}">
        ...
        <select {{ Request::segment(4) == 'edit' ? "disabled" : "" }} id="modelo_id" name="modelo_id" class="form-control">            
...
<div class="row">
    <div class="form-group col-md-6 col-sm-6 col-xs-12 {{ $errors->has('apelido') ? 'has-error' : ''}}">
        ...
        <input type="text" name="apelido" class="form-control" value="{{ isset($equipamento->apelido) ? $equipamento->apelido : '' }}{{old('apelido')}}">
    </div>
</div>
...
<div class="row">
    <div class="form-group col-md-4 col-sm-4 col-xs-12 {{ $errors->has('numeroserie') ? 'has-error' : ''}}">
        ...
        <input type="text" name="numeroserie" class="form-control" value="{{ isset($equipamento->numeroserie) ? $equipamento->numeroserie : '' }}{{old('numeroserie')}}">
    </div>
</div>
...
<div class="row">
    <div class="form-group col-md-4 col-sm-4 col-xs-12">
        ...
        <input type="text" name="patrimonio" class="form-control" value="{{ isset($equipamento->patrimonio) ? $equipamento->patrimonio : '' }}{{old('patrimonio')}}">
    </div>
</div>
...
<div class="row">
    <div class="form-group col-md-8 col-sm-8 col-xs-12">
        ...
        <textarea name="descricao" class="form-control" rows="3">{{ isset($equipamento->descricao) ? $equipamento->descricao : '' }}{{old('descricao')}}</textarea>
    </div>
</div>