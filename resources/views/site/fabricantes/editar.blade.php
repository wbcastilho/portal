...
@section('subtitulo')
    Fabricantes <small>(Formulário)</small> 
@endsection
...
@section('content')   
    ...
    <form id="meuForm" class="form" role="form" action="{{ route('fabricantes.store') }}" enctype="multipart/form-data" method="post">
        @csrf
        @method('PUT')
        ...
        <div class="box-body">
            <div class="row">
                <div class="form-group col-md-2 col-sm-2 col-xs-2">                                                              
                    ...
                    <input disabled type="text" id="id" name="id" class="form-control" value="{{ isset($fabricante->id) ? $fabricante->id : '' }}{{old('id')}}">                                 
                </div> 
            </div>

            @include('site.fabricantes._form')                   
        </div>                       
    ...
    <input type="hidden" name="hidId" id="hidId" value="{{ isset($fabricante->id) ? $fabricante->id : '' }}{{old('id')}}" >
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Informações do fabricante alteradas com sucesso!</p>
                </div>
